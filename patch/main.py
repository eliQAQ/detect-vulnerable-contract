...
def main():
    ...
    nowDir = "./dataset/smartbugs/metadata_withmode"
        ...
        for filename in files:
            if ".json" in filename:
                ...
                with open(open_path) as f:
                    ...
                    reentrancy, mode = resolve_metadata(metadata)
                    with open("./dataset/smartbugs/reentrancy/" + filename[:-4] + "bin") as f:
                ...
                open_path = "./dataset/smartbugs/contrast_patch2/" + filename[:-4] + "bin"
