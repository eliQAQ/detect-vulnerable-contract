...
# 加载模型
time1 = datetime.now()
model = load_model('./saved_model/traincontrastv3_150batch_size32KLSTM64epoch100_train0.6_2_dimension_data3_5_8_120230511-181526.h5', custom_objects={'Attention': Attention})
#model = load_model('your_model_path.h5', custom_objects={'AttentionLayer': attention.AttentionLayer})
y_pred = model.predict(X_test_res, batch_size=32, verbose=0)
time2 = datetime.now()
print(time2 - time1)
